...
public class BookingController {
    ...
    @GetMapping("/retrieveBooking/{bookingId}")
    public Booking retrieveBooking(@PathVariable String bookingId) {
        return bookingStoreService.fetchBookingEvent(bookingId);
    }
